import './App.css';
import "./components/componentsCSS/LoginPageCSS.css"
...
const PublicRoute = ({component: Component, restricted, changeLogFunc}) => {
    return (
        <Route render={props => (
            localStorage.getItem('loggedIn') && restricted ? <Redirect to="/" /> : <Component changeLog ={()=> changeLogFunc}/> 
        )} />
    )
}
      ...
      <main>
          ...
          <BrowserRouter>
              <Switch>
                  ...
                  <PublicRoute restricted = {false} isLogged={isLoggedIn} setIsLoggedIn={() => changeLog} component={LoginPage} exact path = "/"  />
